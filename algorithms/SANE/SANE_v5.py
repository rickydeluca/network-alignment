...
class SANE(NetworkAlignmentModel):
    ...
    def train_supervised(self):
        ...
        def _train_one_step():
            ...
            y_source2target, y_target2source = self.mapper.loss(source_embeddings, target_embeddings)
            ...
            pred_aligns = self.predictor.pred(y_source2target, y_target2source)

            # Backward step
            loss = self.criterion_map(pred_aligns, train_labels)
            loss.backward()
